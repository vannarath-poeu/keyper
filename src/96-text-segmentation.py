...
def main():
    ...
    minmimas = argrelextrema(activated_similarities, np.less, order=2) #order parameter controls how frequent should
    ...
    with open(f"output/midas/{dataset_name}/{id}-out.txt", "w") as f:
        f.write(text)
